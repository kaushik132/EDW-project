...
class ToolCategoryController extends AdminController
{
    /**
    ...
    {
        $grid = new Grid(new ToolCategory());
    ...
    {
        $show = new Show(ToolCategory::findOrFail($id));
    ...
    {
        $form = new Form(new ToolCategory());
